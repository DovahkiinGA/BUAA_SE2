...
def readFiles():
    ...
    files = ["/meow/sourceData/authors/aminer_authors_0.txt", "/meow/sourceData/authors/aminer_authors_1.txt",
             "/meow/sourceData/authors/aminer_authors_2.txt", "/meow/sourceData/authors/aminer_authors_3.txt"]
