...
def readFiles():
    ...
    files = ["/meow/sourceData/papers/aminer_papers_8.txt", "/meow/sourceData/papers/aminer_papers_9.txt",
             "/meow/sourceData/papers/aminer_papers_10.txt","/meow/sourceData/papers/aminer_papers_11.txt"]
