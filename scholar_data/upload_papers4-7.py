...
def readFiles():
    ...
    files = ["/meow/sourceData/papers/aminer_papers_4.txt", "/meow/sourceData/papers/aminer_papers_5.txt",
             "/meow/sourceData/papers/aminer_papers_6.txt","/meow/sourceData/papers/aminer_papers_7.txt"]
