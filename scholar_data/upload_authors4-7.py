...
def readFiles():
    ...
    files = ["/meow/sourceData/authors/aminer_authors_4.txt", "/meow/sourceData/authors/aminer_authors_5.txt",
             "/meow/sourceData/authors/aminer_authors_6.txt", "/meow/sourceData/authors/aminer_authors_7.txt"]
